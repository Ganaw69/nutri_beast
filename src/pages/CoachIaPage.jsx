...
export const CoachIaPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-6">
      <div className="bg-gradient-to-r from-surface-dark via-surface-high to-surface-dark border border-accent-gold/40 p-6 rounded-2xl flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="font-heading font-black text-xl text-white uppercase">COACH IA NUTRITION & ATHLETISME</h1>
      ...
      <div className="bg-surface border border-white/10 rounded-2xl h-[480px] flex flex-col justify-between overflow-hidden shadow-2xl">
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          {messages.map((msg) => (
            ...
            >
              ...
              <div
                className={`max-w-lg p-4 rounded-2xl text-xs sm:text-sm space-y-3 ${
                  msg.sender === "user"
        ...
        <form
          ...
          className="p-4 bg-surface-dark border-t border-white/10 flex gap-3"
        >
          <input
            type="text"
            ...
            className="flex-1 bg-surface border border-white/10 rounded-xl px-4 py-3 text-xs sm:text-sm text-white placeholder-gray-500 focus:outline-none focus:border-accent-gold"
          />
          <button
            type="submit"
            className="bg-accent-gold hover:bg-yellow-400 text-background font-heading font-bold px-5 py-3 rounded-xl transition-all shadow-lg flex items-center gap-2 text-xs"
          >
            <span>ENVOYER</span>
